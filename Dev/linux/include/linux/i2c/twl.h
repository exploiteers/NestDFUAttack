...
#define TWL4030_PM_MASTER_KEY_CFG1	        0xFC 	//0xc0 Fix Key values
#define TWL4030_PM_MASTER_KEY_CFG2	        0x96 	//0x0c
...
#define DEV_GRP_ALL		(DEV_GRP_P3 | DEV_GRP_P2 | DEV_GRP_P1)
