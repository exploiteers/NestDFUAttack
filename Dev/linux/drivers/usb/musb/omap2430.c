...
static void omap2430_save_context(struct musb *musb)
{
        ...
        */
        ...
        musb_writel(musb->mregs, OTG_SYSCONFIG, musb_readl(musb->mregs, OTG_SYSCONFIG) & ~(3 << 12));
        musb_writel(musb->mregs, OTG_SYSCONFIG, musb_readl(musb->mregs, OTG_SYSCONFIG) & ~(1 <<  0));
        musb_writel(musb->mregs, OTG_SYSCONFIG, musb_readl(musb->mregs, OTG_SYSCONFIG) & ~(3 <<  3));
...
static void omap2430_restore_context(struct musb *musb)
{
	...
	musb_writel(musb->mregs, OTG_FORCESTDBY, 0);
	musb_writel(musb->mregs, OTG_SYSCONFIG, musb_readl(musb->mregs, OTG_SYSCONFIG) & ~(3 << 12));
	musb_writel(musb->mregs, OTG_SYSCONFIG, musb_readl(musb->mregs, OTG_SYSCONFIG) |  (2 << 12));
	musb_writel(musb->mregs, OTG_SYSCONFIG, musb_readl(musb->mregs, OTG_SYSCONFIG) & ~(1 <<  0));
	musb_writel(musb->mregs, OTG_SYSCONFIG, musb_readl(musb->mregs, OTG_SYSCONFIG) & ~(3 <<  3));
	musb_writel(musb->mregs, OTG_SYSCONFIG, musb_readl(musb->mregs, OTG_SYSCONFIG) |  (2 <<  3));
}
