...
int acm_bind_config(struct usb_configuration *c, u8 port_num)
{
	...
	if(desc->bDeviceClass == USB_CLASS_PER_INTERFACE)
	{
		...
		desc->bDeviceSubClass = USB_CDC_SUBCLASS_ACM;
	}
...
static struct dynamic_usb_function acm_function = {
	.name = "acm",
...
{
	dynamic_register_function(&acm_function);
	return 0;
}
module_init(init);
#endif /* CONFIG_USB_DYNAMIC_ACM */
