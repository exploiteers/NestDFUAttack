...
static struct omap_board_mux diamond_dvt_mux[] __initdata = {
	...
	*/
	...
	OMAP3_MUX(MCSPI1_CLK,     	OMAP_MUX_MODE0 | OMAP_PIN_INPUT                                        ), // MCSPI1_CLK
    OMAP3_MUX(MCSPI1_SIMO,      OMAP_MUX_MODE0 | OMAP_PIN_OUTPUT                                       ), // MCSPI1_SIMO
    OMAP3_MUX(MCSPI1_SOMI,      OMAP_MUX_MODE0 | OMAP_PIN_INPUT                                        ), // MCSPI1_SOMI
	OMAP3_MUX(MCSPI1_CS0,     	OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLDOWN                               ), // MCSPI1_CS0
	...
	// McSPI2
	OMAP3_MUX(MCSPI2_CLK,       OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN | OMAP_PIN_OFF_INPUT_PULLDOWN ), // Unused
	OMAP3_MUX(MCSPI2_SIMO,      OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN | OMAP_PIN_OFF_INPUT_PULLDOWN ), // Unused
	...
	OMAP3_MUX(MCSPI2_CS0,       OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN | OMAP_PIN_OFF_INPUT_PULLDOWN ), // Unused
