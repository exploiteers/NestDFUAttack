...
/* Samsung K4X51163PI-FCG6 (165MHz optimized) */
...
#define SAMSUNG_TDPL_165						 3
#define SAMSUNG_TDAL_165						 5
#define SAMSUNG_V_ACTIMA_165	((SAMSUNG_TRFC_165 << 27) |		\
		(SAMSUNG_TRC_165 << 22) | (SAMSUNG_TRAS_165 << 18) |	\
		(SAMSUNG_TRP_165 << 15) | (SAMSUNG_TRCD_165 << 12) |	\
		(SAMSUNG_TRRD_165 << 9) | (SAMSUNG_TDPL_165 << 6) |	\
		(SAMSUNG_TDAL_165))

#define SAMSUNG_TWTR_165						 1
#define SAMSUNG_TCKE_165						 2
#define SAMSUNG_TXP_165							 1
#define SAMSUNG_XSR_165							20
#define SAMSUNG_V_ACTIMB_165	((SAMSUNG_TCKE_165 << 12) |		\
		(SAMSUNG_XSR_165 << 0) | (SAMSUNG_TXP_165 << 8) |	\
		(SAMSUNG_TWTR_165 << 16))
